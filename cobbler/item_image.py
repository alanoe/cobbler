...
FIELDS = [
    ...
    ['autoinst', '', 0, "Automatic installation file", True, "Path to autoinst/answer file template", 0, "str"],
...
class Image(item.Item):
    ...
    def set_autoinst(self, autoinst):
        """
        Set the autoinst path, this must be a local file.

        It may not make sense for images to have autoinsts.  It really doesn't.
        ...
        not be a autoinst per se, it might be a Windows answer file (SIF) etc.
